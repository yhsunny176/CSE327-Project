...
from . import job_views  # Ensure this import is correct
urlpatterns = [
    ...
    path('jobs/applications/my_applications/', job_views.get_applications, name='get_applications'),  # View applications made by the current user
